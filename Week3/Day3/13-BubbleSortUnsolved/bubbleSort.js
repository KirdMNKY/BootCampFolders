...
var swapped = false;
var temp = 0;
var DispSorted = document.getElementById("result");
// Display the unsorted array in the `#start` div of `index.html`.
var DispUnsorted = document.getElementById("start");

DispUnsorted.textContent = unsortedArr;
...
DispSorted.textContent = unsortedArr;

}

//not a bubble sort....looks at first and compares it to rest of array then looks at 2nd and compares to rest of array etc.
